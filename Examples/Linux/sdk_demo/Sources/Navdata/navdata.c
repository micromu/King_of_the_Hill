...
//ME: register here every callback function needed. Those functions ill be called every time some navdata arrive from the drone.
//      see guide for MACRO. 
//N.B. tag detection is a NAVDATA packet
