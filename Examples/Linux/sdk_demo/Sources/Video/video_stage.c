...
C_RESULT output_gtk_stage_transform( void *cfg, vp_api_io_data_t *in, vp_api_io_data_t *out)
{
  ...
  //ME: previous group added here the calls to the custom functions that analise the video stream
  //e.g.
  //distanceFromTargetInCm(pixbuf_data, &distanceInCmParameter, &pixelsFromCenterParameter, &chancheOfShootParameter);
  //TODO: add something that search for hill and enemy recognition and than update distance value!
  //something like:
  // recognizeHills(pixbuf_data);
  // recognizeEnemy(pixbuf_data);
  // IsThereSomethingInSight(pixbuf_data);
  //N.B. see king-of-the-hill-old for my previous customization
